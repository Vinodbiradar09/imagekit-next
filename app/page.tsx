...
interface Video {
  ...
  title: string;
  videoUrl: string;
  [key: string]: any; // to allow additional fields if any
}
    ...
    const fetchFeaturedVideos = async () => {
      try {
        ...
        const validVideos = videosData
          .filter((video: Video) => video && video._id && video.title && video.videoUrl)
          .slice(0, 6);
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 bg-gradient-to-b from-black via-gray-900 to-black">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 font-light leading-relaxed">
            Experience the future of video sharing with AI-powered tools. <br className="hidden md:block" />
